      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <AnimatedCard animation="slide" delay="0ms">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
              ...
              <button
                ...
                className="mt-4 px-4 py-2 bg-primary-blue dark:bg-primary-purple text-white dark:text-neutral-white rounded-md hover:bg-primary-purple dark:hover:bg-accent-lavender"
              >
                Test Email Service
              </button>
            </div>
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          <div className="flex-1 min-w-[200px]">
            <input
              ...
              } focus:outline-none focus:ring-2 focus:ring-primary-blue dark:focus:ring-primary-purple`}
            />
          </div>
          <select
            value={filterStatus}
          ...
          <button
            ...
            className={`inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium ${
              isDarkMode 
                ? 'text-neutral-white bg-primary-purple hover:bg-accent-lavender disabled:bg-gray-600' 
                : 'text-white bg-primary-blue hover:bg-primary-purple disabled:bg-gray-400'
            }`}
          >
            {loading ? (
        ...
        <div className="mt-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className={`text-2xl font-bold ${isDarkMode ? 'text-primary-purple' : 'text-primary-blue'}`}>Shipments</h2>
            <button
              onClick={() => setShowShipmentForm(true)}
              className={`inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium ${
                              isDarkMode 
                ? 'text-neutral-white bg-primary-purple hover:bg-accent-lavender' 
                : 'text-white bg-primary-blue hover:bg-primary-purple'
              }`}
            >
                    ...
                    <tr key={shipment.id} className={`hover:bg-gray-50 dark:hover:bg-gray-700`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button
                          ...
                          className={`text-primary-blue dark:text-primary-purple hover:text-primary-purple dark:hover:text-accent-lavender mr-3`}
                        >
                          <FaMapMarkerAlt />
                        </button>
                        <button
